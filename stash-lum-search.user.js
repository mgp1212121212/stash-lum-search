// ==UserScript==
// @name         Stash Luminance Search
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  This script adds search link to luminance trackers in Stash
// @author       jtt
...
async function searchHF(tracker = "HF") {
...
function injectHFButton() {
    ...
    // prevent duplicates
    if (document.getElementById("hf-search")) return;
    ...
    btn.innerText = "Search HappyFappy";
...
function injectEmpButton() {
    ...
    // prevent duplicates
    if (document.getElementById("emp-search")) return;
    ...
    btn.innerText = "Search Empornium";
